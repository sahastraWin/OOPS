...
public class Encapsulation {
    public static void main(String[] args) {
        ...
        SportsCars mySportsCars = new SportsCars("Ford", "Mustang");

        mySportsCars.startEngine();
        mySportsCars.shiftGear(1);
        mySportsCars.accelerate();
        mySportsCars.shiftGear(2);
        mySportsCars.accelerate();
        mySportsCars.brake();
        mySportsCars.stopEngine();
        ...
        System.out.println("Current Speed of My Sports Car is " + mySportsCars.getSpeed());
    }
}